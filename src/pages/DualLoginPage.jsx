                ...
                <div className="text-center scale-110">
                    ...
                    <div className="mt-10 relative group">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className={`w-44 h-44 rounded-full blur-2xl opacity-25 ${role === "doctor" ? "bg-cyan-400" : "bg-pink-400"
                                } animate-pulse`} />
                        </div>
                        ...
                        <div className="relative bg-white rounded-full p-6 shadow-2xl w-36 h-36 mx-auto flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                            <img
                                ...
                                alt="Logo"
                                className={`w-32 h-32 object-contain drop-shadow-xl ${role === "doctor" ? "glow-logo-cyan" : "glow-logo-pink"
                                    } animate-bounce-slow`}
                            />
                        </div>
                    </div>
